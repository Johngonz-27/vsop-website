...
import { preschoolContent } from "../../../../data/content";
...
export default function Preschool() {
  const content = preschoolContent;
    ...
    <Layout>
      ...
      <section className="bg-[#f7f8f3]">
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-8 md:py-24 lg:px-10">
          <div className="max-w-2xl">
            <p className="text-sm font-semibold uppercase tracking-[0.14em] text-[#035921]">
              {content.learningProgram.number} —{" "}
              {content.learningProgram.eyebrow}
            </p>

            <h2 className="mt-4 text-3xl font-semibold tracking-tight text-[#0d0d0d] sm:text-4xl">
              {content.learningProgram.title}
            </h2>

            <p className="mt-5 text-base leading-7 text-[#626862]">
              {content.learningProgram.description}
            </p>
          </div>

          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {content.learningProgram.items.map((item) => {
              const Icon =
                learningIcons[item.icon as keyof typeof learningIcons];
      ...
      <section className="bg-white">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 sm:px-8 md:py-24 lg:grid-cols-2 lg:items-center lg:px-10">
          <div className="relative aspect-[4/3] overflow-hidden bg-[#e5e9df]">
            <Image
              src={content.whatChildrenLearn.image.src}
              alt={content.whatChildrenLearn.image.alt}
              fill
          ...
          <div className="lg:pl-6">
            <p className="text-sm font-semibold uppercase tracking-[0.14em] text-[#035921]">
              {content.whatChildrenLearn.number} —{" "}
              {content.whatChildrenLearn.eyebrow}
            </p>

            <h2 className="mt-4 text-3xl font-semibold tracking-tight text-[#0d0d0d] sm:text-4xl">
              {content.whatChildrenLearn.title}
            </h2>

            <p className="mt-5 text-base leading-8 text-[#626862]">
              {content.whatChildrenLearn.description}
            </p>

            <div className="mt-8 grid gap-x-8 gap-y-5 sm:grid-cols-2">
              {content.whatChildrenLearn.items.map((item) => (
                <div key={item} className="flex items-start gap-3">
                  <span className="mt-2 h-1.5 w-1.5 shrink-0 bg-[#08a63f]" />

                  <span className="text-sm leading-6 text-[#4f574f]">
                    {item}
                  </span>
                </div>
              ))}
      ...
      <section className="bg-[#f7f8f3]">
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-8 md:py-24 lg:px-10">
          <div className="grid gap-12 lg:grid-cols-[1fr_0.8fr]">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.14em] text-[#035921]">
                {content.learningEnvironment.number} —{" "}
                {content.learningEnvironment.eyebrow}
              </p>

              <h2 className="mt-4 max-w-xl text-3xl font-semibold tracking-tight text-[#0d0d0d] sm:text-4xl">
                {content.learningEnvironment.title}
              </h2>

              <p className="mt-5 max-w-2xl text-base leading-8 text-[#626862]">
                {content.learningEnvironment.description}
              </p>
            </div>

            <div className="grid gap-4">
              {content.learningEnvironment.items.map((item, index) => (
                <div
                  key={item}
                  className="flex gap-5 border border-[#dce2d8] bg-white p-5"
                >
                  <span className="text-sm font-semibold text-[#08a63f]">
                    {String(index + 1).padStart(2, "0")}
                  </span>

                  <p className="text-sm font-medium leading-6 text-[#303630]">
                    {item}
                  </p>
                </div>
              ))}
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-8 md:py-24 lg:px-10">
          <div className="max-w-2xl">
            <p className="text-sm font-semibold uppercase tracking-[0.14em] text-[#035921]">
              {content.dailyExperience.number} —{" "}
              {content.dailyExperience.eyebrow}
            </p>

            <h2 className="mt-4 text-3xl font-semibold tracking-tight text-[#0d0d0d] sm:text-4xl">
              {content.dailyExperience.title}
            </h2>

            <p className="mt-5 text-base leading-7 text-[#626862]">
              {content.dailyExperience.description}
            </p>
          </div>

          <div className="mt-12 border-y border-[#e1e5df]">
            {content.dailyExperience.items.map((item) => (
              <div
                key={item.number}
                className="grid gap-4 border-b border-[#e1e5df] py-7 last:border-b-0 md:grid-cols-[70px_260px_1fr] md:items-start"
              >
                <span className="text-sm font-semibold text-[#08a63f]">
                  {item.number}
                </span>
                ...
                <p className="max-w-2xl text-sm leading-7 text-[#687068]">
                  {item.text}
                </p>
              </div>
            ))}
          ...
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.14em] text-[#b8d7b7]">
                {content.developmentalFocus.number} —{" "}
                {content.developmentalFocus.eyebrow}
              </p>

              <h2 className="mt-4 text-3xl font-semibold tracking-tight text-white sm:text-4xl">
                {content.developmentalFocus.title}
              </h2>
            </div>

            <div className="grid gap-x-10 gap-y-8 sm:grid-cols-2">
              {content.developmentalFocus.items.map((item) => (
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-8 md:py-24 lg:px-10">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-sm font-semibold uppercase tracking-[0.14em] text-[#035921]">
              {content.parents.number} — {content.parents.eyebrow}
            </p>
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {content.parents.links.map((item) => (
              <Link
                key={item.number}
                href={item.href}
